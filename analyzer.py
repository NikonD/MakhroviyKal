...
{
  "student_name": "Фамилия Имя Отчество — аккуратно как написано рукой",
...
Правила:
- ФИО в этой форме написано в одну строку после слова "ФИО" — внимательно прочитай рукописный текст. Если буквы НЕ ЯСНЫ — лучше оставь пустую строку, чем выдумывай (имя будет перепроверено по сертификатам).
- Дисциплины — пронумерованный список (1-5) после фразы "Прошу Вас признать результаты неформального обучения, по дисциплинам:". Распознай каждую написанную строку. Опечатки рукописного текста исправляй на корректные академические названия (например "Обектно ориентрованное программирование" -> "Объектно-ориентированное программирование", "Информационно-комуникационние технологии" -> "Информационно-коммуникационные технологии").
